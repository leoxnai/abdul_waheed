...
export default function AdminServices() {
  ...
  const columns = [
    ...
    { key: 'status', label: 'Status', render: (v) => <span className={`px-2 py-1 rounded-full text-xs ${v === 'published' ? 'bg-green-500/10 text-green-400' : 'bg-yellow-500/10 text-yellow-400'}`}>{v}</span> },
